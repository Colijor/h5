$(function(){
	/*点击不同div跳转不同的界面*/		
	/*屏幕码*/
	$('.ho_ping').click(function() {	
	    location.href="/h5/shuluma.html";
	});
	
	/*个人中心*/
	$('.ho_ge').click(function() {	
	    location.href="/h5/personal_Center.html";
	});
	
	/*扫一扫*/
	//$('.ho_sao').click(function() {	
	$('.ho_sao11').click(function() {	
	    location.href="/h5/sweeping.html";
	    //调用微信扫一扫功能所在的页面
		/*var url = "/h5/sweeping.html";						
		    //ajax注入权限验证 
		    $.ajax({ 
		        //与服务器交互
		        url:serverUrl, 
